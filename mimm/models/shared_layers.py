...
class Conv2dNormActivation(ConvNormActivation):
    ...
    Args:
        ...
        norm_layer (Callable[..., nn.Module], optional): Norm layer that will be stacked on top of the convolution layer. If ``None`` this layer won't be used. Default: ``nn.BatchNorm``
